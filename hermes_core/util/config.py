...
def _find_config_files():
    ...
    module_dir = Path(hermes_core.__file__).parent
...
def get_and_create_download_dir():
    ...
    download_dir = (
        Path(hermes_core.config.get("downloads", "download_dir")).expanduser().resolve()
    )
    ...
    return hermes_core.config.get("downloads", "download_dir")
...
def get_and_create_sample_dir():
    ...
    """
    sample_dir = (
        Path(hermes_core.config.get("downloads", "sample_dir")).expanduser().resolve()
    )
    ...
    return hermes_core.config.get("downloads", "sample_dir")
...
def copy_default_config(overwrite=False):
    ...
    """
    config_filename = "configrc"
    config_file = Path(hermes_core.__file__).parent / "data" / config_filename
